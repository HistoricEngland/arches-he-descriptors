...
module.exports = {
  input: {
    path: "./arches_he_descriptors/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_he_descriptors/locale", // output path of all created files
